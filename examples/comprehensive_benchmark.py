...
def main():
    ...
    all_methods = [
        ...
        ("prefix_window",  {"window_size": 256, "prefix_len": 32}),
        ("strided_cache",  {"window_size": 256, "stride": 4, "prefix_len": 0}),
        ("block_cache",    {"window_size": 256, "block_size": 64, "keep_per_block": 8, "prefix_len": 0}),
        ("budget_cache",   {"window_size": 256, "old_budget": 64, "prefix_len": 0}),
        ("quant_int8", {}),
        ("quant_int4", {}),
