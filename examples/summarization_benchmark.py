...
def main():
    ...
    print("="*80)
    print(results_df[["method", "elapsed_sec", "avg_time_per_sample", 
                      "rouge1_f", "rouge2_f", "rougeL_f"]].to_string(index=False))
    ...
    print("="*80)
    print(variants_df[["variant", "elapsed_sec", "rouge1_f", "rouge2_f", "rougeL_f"]].to_string(index=False))
